...
To improve and practice, we plan to keep building both sides by using a mix of online courses and hands-on projects with datasets that we find interesting. We’ll continue using our GitHub sites to share those projects, track our progress, and build a portfolio. More importantly, it gives us a way to keep collaborating, combine our strengths, and keep improving together over time.