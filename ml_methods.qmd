...
plt.title("K-Means Clusters Based on Required Skills", fontsize=15, fontweight="bold")
...
sns.barplot(data=cluster_counts_pd, x="cluster", y="count", color="steelblue")

plt.title("Number of Job Postings in Each Cluster")
plt.xlabel("Cluster")
plt.ylabel("Count")
plt.tight_layout()
plt.show()
